...
def drawLatencyBarPlayer(exData,saveName):
...
if __name__ == '__main__':
    ...
    global colorG
    colorG = ['mediumblue']
    exDataPlayer = ft.filteByLogTypeWhich(root,"Latency","p")
    drawLatencyBarPlayer(exDataPlayer,save+'data_latency_Player.svg')
